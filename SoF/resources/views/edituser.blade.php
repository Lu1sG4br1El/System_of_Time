...
<br>
    ...
    <div class="container formxd">
        <div class="text-center mt-2">
            <h2 class="fw-normal">Editar Usuario</h2>
        </div>
        <div class="text-center m-2 mb-4">
            <svg class="bi" width="100" height="100"><use xlink:href="#prov"/></svg>
        </div>

        <form method="post" action="{{ route('editusu.update', $usu->id) }}">
            @csrf
            @method('PUT')
    ...
    <div class="form-group">
        ...
        <div class="text-center">
            <button type="submit" name="btnaddU" class="btn btn-dark m-3" onclick="Actualizar()">Actualizar</button>
        </div>
