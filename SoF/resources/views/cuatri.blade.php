...
<style>
    ...
    <div class="container formxd">
        <div class="text-center mt-2">
            <h2 class="fw-normal">Agregar Cuatrimestre</h2>
        </div>
...
<!--            @csrf-->
            <div class="row g-3 align-items-center">
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control" name="nameCuatri" placeholder="Introduce la descripción del cutri..." required>
                    </div>
